...
if TOKEN_CSRF:
    ...
    CSRF_TRUSTED_ORIGINS = ['https://projetonetflix-production.up.railway.app/']
else:
...
ALLOWED_HOSTS = ["https://projetonetflix-production.up.railway.app", "localhost", "127.0.0.1/"]
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'filme.novos_context.lista_filme_recentes',
